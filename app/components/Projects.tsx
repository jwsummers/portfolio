...
const projects = [
  ...
  },
  {
    ...
    github: "https://github.com/jwsummers/7MillionMedia",
  ...
  },
  {
    ...
    description:
      "A web app for technicians to compare tire sizes to make decisions on replacement based off company standards",
...
const Projects: React.FC = () => {
  ...
  return (
    <div id="projects" className="bg-muted-gradient-2 py-12">
      ...
      <p className="mt-6 mb-4 p-4 text-center max-w-lg mx-auto">
        Here are some of my latest projects, feel free to inspect the code or
        live site by following the links provided.
      </p>
