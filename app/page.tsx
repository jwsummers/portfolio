    ...
    <>
      ...
      />
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 justify-center items-center">
            ...
            <Link href="#contact" className="w-40 md:w-auto px-4 py-2 md:px-6 md:py-3 bg-green-600 rounded hover:bg-green-700 hover-bounce text-sm md:text-base text-center">
              Contact Me
            </Link>
          </div>
        ...
        <div className="absolute bottom-10 text-center w-full cursor-pointer animate-bounce" onClick={handleScroll}>
